/*
const getChartDataCenter = (user_submissions, center_submissions, global_submissions) => {
    ...
    try {
        ...
        allYears.forEach(year => {
            ...
            const yearData = dimensions.map(dimension => {
                const best = userAggregated[dimension];
                ...
                return {
                    ...
                    status: getStatus(centerValue, best)
                };
            });
...
module.exports = getChartDataCenter;
*/
