...
import { Building, Mail, MapPin, Globe, Hash, Book } from "lucide-react"

import editCenter from "../../../../functions/admin/centers/editCenter"
import getCountries from "../../../../functions/constants/get_countries"

const EditCenter = ({ seletedCenter, centers, setCenters, isOpen, onOpenChange }) => {

    const [isLoading, setIsLoading] = useState(false)

    const [formErrors, setFormErrors] = useState({})

    const [formData, setFormData] = useState({ id: '', name: "", code: "", address: "", email: "", country: "", city: "", research_area: "" })
    ...
    useEffect(() => {
        ...
        if (seletedCenter) {
            ...
            setFormData({
                ...
                name: seletedCenter.name || "",

                code: seletedCenter.code || "",

                address: seletedCenter.address || "",

                email: seletedCenter.email || "",

                country: seletedCenter.country || "",

                city: seletedCenter.city || "",

                research_area: seletedCenter.research_area || ""
    ...
    const handleSubmit = async () => {
        ...
        const result = await editCenter(formData, centers, setCenters)
        ...
        >
            <ModalContent>
                <div className="flex flex-col md:flex-row rounded-lg overflow-hidden shadow">
                    <div className="w-full md:w-1/2 p-5">
                        <ModalHeader className="flex flex-col gap-1 text-center p-0 mb-3">
                            ...
                            <p className="text-sm text-gray-500 mt-1">
                                Update details for the research center
                            </p>
                        </ModalHeader>
                                ...
                                >
                                    ...
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <Autocomplete
                                            ...
                                            defaultSelectedKey={formData.country.toLocaleLowerCase()}
                    ...
                    <div className="w-full md:w-1/2 bg-gradient-to-br from-cyan-500 to-emerald-500 p-8 flex flex-col justify-center items-center text-white">
                        <div className="text-center">
                            ...
                            <p className="mb-8 text-center text-cyan-100">
                                Modify the details of the research center
                            </p>
                        </div>
                    </div>
                </div>
