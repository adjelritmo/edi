import { Drawer, DrawerContent, DrawerHeader, DrawerBody, Avatar, Tabs, Tab, Card, CardBody, Chip } from "@heroui/react"

import { Briefcase, Mail, Award, Building, User, Cake, Flag, GraduationCap } from "lucide-react"

const ViewUser = ({ user, isOpen, onOpenChange, currentCenterName }) => {
    ...
    return (
        ...
        >
            <DrawerContent>
                ...
                <DrawerHeader className="flex flex-col gap-4 pt-6 px-6 bg-gradient-to-br from-cyan-400 via-cyan-700 to-emerald-500 text-white relative overflow-hidden">
                    ...
                    <div className="flex flex-col items-center text-center gap-3 relative z-10">
                        ...
                        <div className="flex flex-wrap justify-center gap-4 text-white/80 text-xs">
                            ...
                            <div className="flex items-center">
                                ...
                                {user?.center?.name || currentCenterName || "No center assigned"}
                            </div>
                        </div>
                    </div>
                </DrawerHeader>
                    ...
                    <div className="space-y-4">
                        ...
                        <Tabs
                            ...
                            classNames={{
                                ...
                                tab: "px-0 h-12",
                                tabContent: "group-data-[selected=true]:text-cyan-600 font-medium text-sm"
                            }}
                        >
                            <Tab
                                key="personal"
                            ...
                            >
                                <div className="space-y-4 pt-4">
                                    ...
                                    <Card className="shadow bg-slate-50/50 border border-slate-100">
