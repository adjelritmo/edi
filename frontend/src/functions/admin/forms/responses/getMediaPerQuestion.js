...
const getMediaPerQuestionAdmin = async (formId) => {
    
    try {

        const { data, status } = await admin_api.get(`/calculate/media/per/response/${formId}`)
...
export default getMediaPerQuestionAdmin