...
import { Table, TableHeader, TableColumn, TableBody, TableRow, TableCell, Input, Button, Chip, Pagination, Card, CardBody, Badge, Progress, Modal, ModalContent, ModalHeader, ModalBody, ModalFooter, Tooltip, Tabs, Tab } from "@heroui/react"
import { Search, Eye, Users as UsersIcon, CheckCircle, Clock, BarChart3, FileText, Download, Mail, AlertCircle, Download as DownloadIcon, Clock as ClockIcon, CheckSquare, Type, MessageSquare, List, Star, ArrowLeft, Building, View, HelpCircle, TrendingUp } from "lucide-react"
import { AppContext } from "../../../contexts/app_context"
import getMediaPerQuestion from "../../../functions/collaborator/forms/responses/getMediaPerQuestion"
...
const FormResponsesView = () => {
                ...
                return (
                    <div className="flex items-center gap-2">
                        ...
                        <div className="flex flex-col">
                            <span className="font-semibold text-gray-900">Member #{submission?.user?.id || 'N/A'}</span>
                        </div>
                    </div>
                )
            case "score":
                ...
                return (
                    <div className="relative flex justify-end items-center gap-2">
                        <Tooltip content="View Details">
                            <Button onPress={() => { setSelectedSubmission(submission); setIsDetailsModalOpen(true) }} isIconOnly size="sm" variant="light">
    ...
    useEffect(() => {
        ...
        getMediaPerQuestion(form.id).then(setQuestionAverages)
